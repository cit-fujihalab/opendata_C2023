...
psql -U postgres -d postgres -c "ANALYZE;" &
find /var/mnt/sdf/sensors_map -name "*2022011*.csv" | xargs -t -P1 -IFILENAME psql -U postgres -d postgres -c "CALL postgres.insert_file('FILENAME')"
psql -U postgres -d postgres -c "ANALYZE;" &
find /var/mnt/sdf/sensors_map -name "*2022012*.csv" | xargs -t -P1 -IFILENAME psql -U postgres -d postgres -c "CALL postgres.insert_file('FILENAME')"
find /var/mnt/sdf/sensors_map -name "*2022013*.csv" | xargs -t -P1 -IFILENAME psql -U postgres -d postgres -c "CALL postgres.insert_file('FILENAME')"
psql -U postgres -d postgres -c "ANALYZE;" &
